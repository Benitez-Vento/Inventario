...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            <div class="card card border-dark border" style="margin-bottom: 30px;">
                <div class="card-body">
        ...
        <div class="col">
            <div class="card card border-dark border">
                ...
                <div style="display:flex; margin-left:200px; margin-right:200px; margin-bottom:0;">
                    <div class="input-group mb-3" style="height: 30px; width:350px; margin-left:150px; margin-top:50px;">
                        <label class="input-group-text" for="inputGroupSelect01">Comprobante </label>
                        <select class="form-select" id="inputGroupSelect01">
                            <option selected>Selecciona</option>
                            <option value="1">Factura</option>
                            <option value="2">Boleta</option>
                            <option value="3">N. Venta</option>
                        </select>
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-md-center">
                            <div class="col-md-auto">
                                <div class="card">
                                    <h5 style="text-align: center">Datos de venta</h5>
                                    <div class="card-body card border-dark border">
                                        Sub-total:<input type="text" class="form-control" id="inputPassword" readonly>
                                        IGV: <input type="text" class="form-control" id="inputPassword" readonly>
                                        Total: <input type="text" class="form-control" id="inputPassword" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div style="display:flex; position:relative; margin-left: 45%;">
                    <button type="submit" class="btn btn-primary" id="savedata" value="create" >Guardar</button>
                    <button type="button" class="btn btn-warning" style="margin-left: 10%;">Cancelar</button>
                </div>
            </div>
        </div>
    </div>
